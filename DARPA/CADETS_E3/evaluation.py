...
def ground_truth_label():
    ...
    # for other batch size 
    # attack_list = [
    # '2018-04-06_11:20:27.216176158~2018-04-06_11:35:35.076152468.txt',
    # '2018-04-06_11:35:35.076152468~2018-04-06_11:50:42.426130863.txt',
    # '2018-04-06_11:50:42.426130863~2018-04-06_12:05:50.066112886.txt',
    # '2018-04-06_12:05:50.066112886~2018-04-06_14:01:21.309597190.txt',
    # ]
    ...
    for hl in history_list:
        ...
        for hq in hl:
            if anomaly_score == 0:
                ...
                anomaly_score = (anomaly_score) * (hq['loss'] + 1)
        name_list = []
        print(f"Anomaly score: {anomaly_score}, beta_day7: {beta_day7}")
